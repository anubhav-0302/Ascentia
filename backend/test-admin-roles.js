// Test admin roles routes specifically
async function testAdminRoles() {
  console.log('🔍 Testing Admin Roles Routes\n');
  ...
  const routes = [
    ...
    { method: 'GET', path: '/api/admin/roles/sidebar/permissions' }
  ];
  ...
  for (const route of routes) {
    ...
    try {
      ...
      console.log('Server crashed, need to restart!');
      break;
    }
  }
}
